...
@UI: {
  headerInfo: { typeName: 'Repair Order', typeNamePlural: 'Repair Orders', title: { type: #STANDARD, value: 'OrderID' } } }
@UI.presentationVariant: [{sortOrder: [{by: 'OrderId', direction: #ASC }]}]

@Search.searchable: true

define root view entity ZC_ORDER_D
...

{
  ...
  key order_uuid,
      ...
      _Customer_L
      ,@Search.defaultSearchElement: true
      _Item : redirected to composition child ZC_ORDER_ITEM_D
      ,
      _Supplier
